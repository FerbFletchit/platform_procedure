...
SWEP.WorldModel = "models/aceofspades/weapons/bluesniper.mdl"

SWEP.ShowViewModel = false
SWEP.ShowWorldModel = false

SWEP.VElements = {
	["pp_sniper_v"] = { type = "Model", model = "models/aceofspades/weapons/bluesniper.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(0, 0.518, -5.715), angle = Angle(90, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["pp_sniper_w"] = { type = "Model", model = "models/aceofspades/weapons/bluesniper.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.909, 1.557, -8), angle = Angle(-22.209, 0, 180), size = Vector(1.499, 1.499, 1.499), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(2, -2, 0), angle = Angle(0, 0, 0) },
...
SWEP.Primary.Damage			= PP["Sniper_Base_Damage"]
SWEP.Primary.Delay = PP["Sniper_Base_Firerate"]
...
SWEP.Primary.Sound = Sound( "pp_weapons/sniper.mp3" )
