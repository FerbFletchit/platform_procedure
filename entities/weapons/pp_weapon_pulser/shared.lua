...
SWEP.WorldModel = "models/aceofspades/tools/block_cannon.mdl"

SWEP.ShowViewModel = false
SWEP.ShowWorldModel = false

SWEP.VElements = {
	["PP_Shotgun_V"] = { type = "Model", model = "models/aceofspades/tools/block_cannon.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(-1.558, 0.518, -3.636), angle = Angle(90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["PP_Shotgun_V"] = { type = "Model", model = "models/aceofspades/tools/block_cannon.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(16.104, 3.635, -4.676), angle = Angle(3.506, -5.844, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.IronSightsAng      = Vector( 4, -0.5, 2 )
...
function SWEP:PrimaryAttack()
 ...
 function SWEP:CSShootBullet( dmg, recoil, numbul, cone )
	...
	bullet.Tracer	= 1
	bullet.TracerName = "purpletracer"
