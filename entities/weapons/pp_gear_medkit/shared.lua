...
SWEP.WorldModel = "models/aceofspades/weapons/satchel.mdl"

SWEP.ShowViewModel = false
SWEP.ShowWorldModel = false

SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/aceofspades/misc/normal_satchel.mdl", bone = "ValveBiped.Bip01_L_Hand", rel = "", pos = Vector(6.752, 4.675, -0.519), angle = Angle(17.531, 180, 8.182), size = Vector(0.6, 0.6, 0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/aceofspades/misc/normal_satchel.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(8.831, 4.675, -3.636), angle = Angle(-180, 40.909, -26.883), size = Vector(0.6, 0.6, 0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Forearm"] = { scale = Vector(0.6, 0.6, 0.6), pos = Vector(-6.112, 2.778, 1.296), angle = Angle(0, 0, 50) },
	["ValveBiped.Bip01_L_Forearm"] = { scale = Vector(0.6, 0.6, 0.6), pos = Vector(-7.963, -0.186, -0.186), angle = Angle(0, 0, -38.889) }
}
...
function SWEP:Initialize()
	timer.Simple(0.01, function()
		...
		self.Primary.Healing = PP["Medkit_Base_Heal"]*Qual
...
function SWEP:PrimaryAttack()
	if SERVER then
		self.Owner:EmitSound("pp_sound_effects/horny.mp3",40,100,1,CHAN_AUTO)
