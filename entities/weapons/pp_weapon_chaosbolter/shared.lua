...
SWEP.WorldModel = "models/aceofspades/weapons/semi.mdl"

SWEP.ShowViewModel = false
SWEP.ShowWorldModel = false

SWEP.VElements = {
	["PP_Shotgun_V"] = { type = "Model", model = "models/aceofspades/weapons/semi.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(0.518, 1, -3.636), angle = Angle(90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["PP_Shotgun_V"] = { type = "Model", model = "models/aceofspades/weapons/semi.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(11.947, 1.557, -3.636), angle = Angle(-12.858, 0, 180), size = Vector(1.3, 1.3, 1.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
