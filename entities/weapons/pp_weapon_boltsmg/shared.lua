...
SWEP.WorldModel = "models/aceofspades/weapons/classic_smg.mdl"

SWEP.ShowViewModel = false
SWEP.ShowWorldModel = false

SWEP.VElements = {
	["PP_Shotgun_V"] = { type = "Model", model = "models/aceofspades/weapons/classic_smg.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(0.518, 2.596, -7.792), angle = Angle(90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["PP_Shotgun_V"] = { type = "Model", model = "models/aceofspades/weapons/classic_smg.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.752, 1.557, -0.519), angle = Angle(-15.195, 0, 180), size = Vector(1.299, 1.299, 1.299), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0, -5, 0), angle = Angle(-7.778, 0, 0) },
	["ValveBiped.Gun"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_Hand"] = { scale = Vector(1, 1, 1), pos = Vector(-0.556, 0, 0), angle = Angle(32.222, 0, 0) }
}

-------------Primary Fire Attributes----------------------------------------
SWEP.Primary.Recoil			= PP["Weapon_Recoil"]
SWEP.Primary.Damage			= PP["SMG_Base_Damage"]
SWEP.Primary.Delay = PP["SMG_Base_Firerate"]
...
SWEP.IronSightsPos = Vector (-7.3, -0, 1)
SWEP.IronSightsAng = Vector (-2, -1, 1.5)

SWEP.Primary.Sound = Sound( "pp_weapons/blotfire.wav" )
