...
SWEP.WorldModel = "models/aceofspades/weapons/lightmachinegun.mdl"

SWEP.ShowViewModel = false
SWEP.ShowWorldModel = false

SWEP.VElements = {
	["PP_Shotgun_V"] = { type = "Model", model = "models/aceofspades/weapons/lightmachinegun.mdl", bone = "ValveBiped.Gun", rel = "", pos = Vector(2.596, 2.596, -1.558), angle = Angle(-90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["PP_Shotgun_V"] = { type = "Model", model = "models/aceofspades/weapons/lightmachinegun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(14.026, 1.557, 1), angle = Angle(180, 0, 0), size = Vector(1.5, 1.5, 1.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-7.778, 0, 0) },
...
SWEP.Primary.Damage			= PP["Heavy_Base_Damage"]
SWEP.Primary.Delay = PP["Heavy_Base_Firerate"]
